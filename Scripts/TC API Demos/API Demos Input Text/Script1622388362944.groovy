...
Mobile.setText(findTestObject('Object Repository/OR API Demos/android.widget.EditText'), GlobalVariable.globaltext, 0)

Mobile.setText(findTestObject('Object Repository/OR API Demos/android.widget.EditText (1)'), 'This is a Cipher Text', 0)

Mobile.setText(findTestObject('Object Repository/OR API Demos/android.widget.EditText (2)'), 'This is a Alias', 0)
